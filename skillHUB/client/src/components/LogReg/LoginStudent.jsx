...
const LoginStudent = () => {
    ...
    const handelSubmit =(e)=>{
        e.preventDefault()
            axios.post('http://localhost:8001/login/student',{email,password})
...
<div style={{width:"50vw"}} className='d-flex justifycontent-center align-items-center bg-secondary vh-80'>
        <div className='bg-white p-3 rounded w-100'>
            ...
            <form onSubmit={handelSubmit}>
                ...
                <button type='submit' className='btn btn-success w-100 rounded-0'><span style={{color:'red'}}>Lo</span>gin</button>
            </form>
        </div>
    </div>
    )
